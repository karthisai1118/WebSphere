#!/usr/bin/perl64 -w
#
# Change from /usr/bin/perl for 32-bit on AIX to /usr/bin/perl64 for 64-bit on AIX to fix error message below on AIX when
# WebSphere interm fix(s) are NFS mounted.
# opendir: Value too large to be stored in data type
...
# script was_imcl_install.sh determines from file /home/wasadm/etc/.ibm/registry/InstallationManager.dat statement location=
# 06/28/18 @002 Mike McIntyre Obtain IBM Installation Manager install directory from /home/wasadm/etc/.ibm/registry/InstallationManager.dat
...
#
# @002. Obtain directory of IBM Installation Manager install directory from /home/wasadm/etc/.ibm/registry/InstallationManager.dat
# statement location=. Below is example.
# location=/opt/IBM/InstallationManager/install
